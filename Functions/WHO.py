...
parser.add_argument('nExploreStep', type=float, help='Explore Step')
parser.add_argument('nExploitStep', type=float, help='Exploit Step')
parser.add_argument('eta', type=float, help='eta')
parser.add_argument('pHi', type=float, help='pHi')
parser.add_argument('localAlpha', type=float, help='localAlpha')
parser.add_argument('localBeta', type=float, help='localBeta')
parser.add_argument('globalAlpha', type=float, help='global Alpha')
parser.add_argument('globalBeta', type=float, help='globalBeta')
parser.add_argument('deltaW', type=float, help='deltaW')
parser.add_argument('deltaC', type=float, help='deltaC')
...
nExploreStep = args.nExploreStep
nExploitStep = args.nExploitStep
eta = args.eta
pHi = args.pHi
localAlpha = args.localAlpha
localBeta = args.localBeta
globalAlpha = args.globalAlpha
globalBeta = args.globalBeta
deltaW = args.deltaW
deltaC = args.deltaC
...
model = WHO.OriginalWHO(epoch=epoch, pop_size=popSize, n_explore_step = nExploreStep, n_exploit_step = nExploitStep, eta = eta, p_hi = pHi,
                         local_alpha=localAlpha, local_beta=localBeta, global_alpha=globalAlpha, global_beta=globalBeta, delta_w=deltaW, delta_c=deltaC)
g_best = model.solve(problem_dict)