...
parser.add_argument('populationSize', type=int, help='Population Size')
parser.add_argument('nClusters', type=int, help='Cluster Count')
...
model = HGSO.OriginalHGSO(epoch=epoch, pop_size=populationSize, n_clusters = nClusters)
g_best = model.solve(problem_dict)
