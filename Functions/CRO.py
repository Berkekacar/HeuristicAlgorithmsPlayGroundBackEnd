...
parser.add_argument('po', type=float, help='po')
parser.add_argument('Fb', type=float, help='Fb')
parser.add_argument('Fa', type=float, help='Fa')
parser.add_argument('Fd', type=float, help='Fd')
parser.add_argument('Pd', type=float, help='Pd')
parser.add_argument('GCR', type=float, help='GCR')
parser.add_argument('gamma_min', type=float, help='gamma_min')
parser.add_argument('gamma_max', type=float, help='gamma_max')
parser.add_argument('nTrials', type=float, help='nTrials')
...
model = CRO.OriginalCRO(epoch=epoch, pop_size=popSize, po = po, Fb = Fb, Fa = Fa, Fd = Fd, Pd = Pd, GCR = GCR, gamma_min = gamma_min, gamma_max = gamma_max, n_trials = nTrials)
g_best = model.solve(problem_dict)