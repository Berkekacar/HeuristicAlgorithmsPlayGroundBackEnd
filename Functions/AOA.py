...
parser.add_argument('miu', type=float, help='miu')
parser.add_argument('moaMin', type=float, help='moaMin')
parser.add_argument('moaMax', type=float, help='moaMax')
...
model = AOA.OriginalAOA(epoch=epoch, pop_size=populationSize, alpha = alpha, miu = miu, moa_min = moaMin, moa_max = moaMax)
g_best = model.solve(problem_dict)