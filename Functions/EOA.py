...
parser.add_argument('nBest', type=float, help='nBest')
...
model = EOA.OriginalEOA(epoch=epoch, pop_size=popSize, p_c = pC, p_m = pM, n_best = nBest, alpha = alpha, beta = beta, gama = gamma)
g_best = model.solve(problem_dict)