...
parser.add_argument('PAR', type=float, help='PAR')
parser.add_argument('nVars', type=float, help='nVars')
...
parser.add_argument('epoch', type=float, help='Epoch')
parser.add_argument('popSize', type=float, help='popSize')
...
model = HS.DevHS(epoch=epoch, pop_size=popSize, c_r = cR, pa_r = PAR)
g_best = model.solve(problem_dict)
