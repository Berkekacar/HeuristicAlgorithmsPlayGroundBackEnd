...
model = GA.BaseGA(epoch=numberOfGenerations, pop_size=populationSize, pc=crossoverProbability, pm=mutationProbability, crossover=crossoverType, selection = selectionType, mutation_multipoints=mutationMultiPoint, mutation=mutationType)
g_best = model.solve(problem_dict)